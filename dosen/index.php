...
<head>
	...
	<title>Dosen | Aplikasi E-Absence</title>
	<meta content='width=device-width, initial-scale=1.0, shrink-to-fit=no' name='viewport' />
	<link rel="icon" href="../assets/img/logo-absen192.png" type="image/x-icon"/>
	<link rel="icon" type="image/png" href="../assets/img/logo-absen192.png"/>
	<!-- Fonts and icons -->
		...
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="index.php" class="logo">
					<img src="../assets/img/logo-absen192.png" alt="navbar brand" class="navbar-brand" width="40">
					<b class="text-white">E-Absence</b>
				</a>
		...
		<footer class="footer">
				<div class="container">
					<div class="copyright ml-auto">
						&copy; <?php echo date('Y');?>  Absensi Mahasiswa Universitas Samudra Langsa (<a href="index.php">4RHYN </a> | 2021)
					</div>				
				</div>
			</footer>
		</div>
