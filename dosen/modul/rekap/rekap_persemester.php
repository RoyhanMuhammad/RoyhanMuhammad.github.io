...
$tglTerakhir = 25;
 ...
 <table width="100%">
 	<tr>
 		<td>
 			<img src="../../../assets/img/unsam.png" width="100" align="right">
 		</td>
 		<td>
 				<center>
 				...
 				<h1>
 					...
 					<small> UNIVERSITAS SAMUDRA</small>
 				</h1>
 				<hr>
 				<em>
				 Jalan Prof. Syarief Thayeb, Meurandeh, Langsa - Aceh 
	<br>Kode Pos 24451
<br>Telepon 0641-7001961</br>
E-mail info@unsam.ac.id
 				</em>
