<div class="page-inner">
                    <div class="page-header">
                        <h4 class="page-title">Dosen Pembimbing Akedemik</h4>
                        <ul class="breadcrumbs">
                            ...
                            <li class="nav-item">
                                <a href="#">Dosen Pembimbing Akedemik (PA)</a>
                            </li>
                            <li class="separator">
                                <i class="flaticon-right-arrow"></i>
                            </li>
                            <li class="nav-item">
                                <a href="#">Daftar Dosen Pembimbing Akedemik (PA)</a>
                            </li>
                        </ul>
                    </div>
                    <div class="row">
                 ...
                 <table class="table table-hover table-sm">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>Kelas</th>
                            <th>Nama Dosen Pembimbing Akedemik (PA)</th>
                            <th>Opsi</th>
                        </tr>
                    </thead>  
                    <tbody>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
                 <div class="modal-header">
                              <h4 id="exampleModalLabel" class="modal-title">Edit Dosen Pembimbing Akedemik (PA)</h4>
...
<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModal" class="modal fade" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
              <div class="modal-header">
                              <h4 id="exampleModalLabel" class="modal-title">Tambah Dosen Pembimbing Akedemik (PA)</h4>
                              <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true">×</span></button>
                            </div>
            <div class="modal-body">
                <form action="" method="post" class="form-horizontal">
