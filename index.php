            ...
            <div class="wrap-login100">
                <form method="post" action="" class="login100-form validate-form">
                    <span class="login100-form-title p-b-48">
                        ...
                        <img src="./assets/img/logo-absen192.png" width="75">
                    </span>
                    ...
                    <br>
						...
						<b>Aplikasi Mobile unduh dibawah Ini :</b>
					<a href="E-Absence.apk" title="Download" class="btn btn-primary"><i aria-hidden="true" class="fa fa-download"></i> DOWNLOAD</a>
<br><br>
