                    ...
                    <div class="container">
                        <div class="page-inner py-5">
                            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                                <div>
                                    <img src="assets/img/unsam.png" width="80">
                                    <h2 class="text-white pb-2 fw-bold"> Universitas Samudra</h2>
                                    <h5 class="text-white op-7 mb-2">Aplikasi Absensi Berbasis Web dan Mobile</h5>
                                </div>
